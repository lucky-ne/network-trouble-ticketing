...
<div class="row mb-4">
    <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h3 class="fw-bold mb-0 text-dark"><i class="fas fa-tags text-danger me-2"></i>Master Kategori Gangguan Jaringan</h3>
                <p class="text-muted small mb-0">Kelola klasifikasi jenis gangguan jaringan (Wi-Fi, LAN, Port, VPN, Server, dll).</p>
            </div>
            <button type="button" class="btn btn-primary px-3 py-2 rounded-3 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalTambahKategori">
