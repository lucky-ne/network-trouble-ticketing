                    ...
                    <table class="table table-b2b table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php foreach ($recent_tickets as $rt): ?>
                                <tr>
                                    <td class="fw-bold text-primary font-monospace"><?= htmlspecialchars($rt['ticket_code']) ?></td>
                                    <td>
                                        <div class="fw-semibold text-dark"><?= htmlspecialchars($rt['company_name']) ?></div>
                                        <span class="circuit-badge"><?= htmlspecialchars($rt['circuit_id']) ?></span>
                                    </td>
                                    <td>
                                        <div class="small fw-semibold"><?= htmlspecialchars($rt['title']) ?></div>
                                        <small class="text-muted"><?= htmlspecialchars($rt['category_name']) ?></small>
                                    </td>
                                    <td><?= get_status_badge($rt['status']) ?></td>
                                    <td>
                                        <a href="<?= base_url('customer/detail_tiket.php?id=' . $rt['id']) ?>" class="btn btn-xs btn-outline-primary py-0 px-2">
                                            Detail
                                        </a>
                                    </td>
                                </tr>
